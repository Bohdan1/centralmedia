(function(i, g, c, h, e, k, f) { /*! Jssor */
    ...
    i.$JssorSlideshowRunner$ = function(n, s, q, u, z) {
                ...
                b.$Each(h, function(G) {
                    ...
                    if (a.$Zoom || a.$Rotate) {
                        ...
                        if (H) {
                            ...
                            f.$Zoom = 1;
                            if (b.fc() || b.$IsBrowserOpera()) d.$Zoom = c.min(d.$Zoom, 2);
                            var N = a.$Rotate || 0;
        ...
        if (b.fc() || b.$IsBrowserOpera() || z && b.$WebKitVersion() < 537) i = 16;
        m.call(f);
        l.call(f, -1e7, 1e7)
    };
    var j = i.$JssorSlider$ = function(q, hc) {
                ...
                if (e != f) {
                    if (A) {
                        ...
                        if (g) {
                            var k = R = b.P(),
                                i = C[t(e)];
                            return i.zb(b.$CreateCallback(h, X, e, i, g, k), x)
                        }
                    }
                    ob(e)
                } else if (a.$Loop) {
        ...
        function Gb(c, d) {
            ...
            b.$Each(Nb, function(a) {
                var c = b.Rb(b.$AttributeEx(a, "autocenter"));
                b.Kf(a, c)
            })
        }
        ...
        if (r) {
            ...
            b.$AddEvent(q, "mouseout", b.Tb(kc, q));
            b.$AddEvent(q, "mouseover", b.Tb(jc, q));
            if (Y) {
        ...
        f.Dc = function(E) {
            if (!u) {
                ...
                for (var f = 0; f < s; f++) {
                    ...
                    a.$ActionMode & 2 && b.$AddEvent(k, "mouseover", b.Tb(b.$CreateCallback(h, t, f), k));
                    y[f] = b.Mb(k)
                }
                u = e
            }
    ...
    i.$JssorCaptionSlideo$ = function(v, j, u, E) {
        ...
        i(m, g);
        var x = j.$Breaks || [],
            k = [].concat(x[b.Rb(b.$AttributeEx(v, "b"))] || []);
        k.push({
            b: f,
            d: k.length ? 0 : u
        });
