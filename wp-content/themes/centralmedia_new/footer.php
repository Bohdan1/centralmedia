            ...
            <div class="col l6 m12 s12">
                ...
                <div class="social-menu-footer">
                    <div class="footer-menu-icons">
                        <a href="#modal2" >
                            <img class="social-logo-footer" src="<?php bloginfo('template_url') ?>/img/social/search.svg" alt="Логотип">
                        </a>
                    </div>
                    <div class="footer-menu-icons">
                        <a href="https://www.facebook.com/centralnemedia/">
                            <img class="social-logo-footer" src="<?php bloginfo('template_url') ?>/img/social/facebook.svg" alt="Логотип">
                        </a>
                    </div>
                    <div class="footer-menu-icons">
                        <a href="https://twitter.com/CentralneMedia" >
                            <img class="social-logo-footer" src="<?php bloginfo('template_url') ?>/img/social/twitter.svg" alt="Логотип">
                        </a>
                    </div>
                    <div class="footer-menu-icons">
                        <a href="https://www.youtube.com/channel/UCYMgvYAKTnPfZ8FjuXLYaEQ" >
                            <img  class="social-logo-footer" src="<?php bloginfo('template_url') ?>/img/social/youtube.svg" alt="Логотип">
                        </a>
                    </div>
                </div>
