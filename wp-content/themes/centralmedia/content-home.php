<div class="row slider-section">
	...
	<div class="col l8 s12 m12">
		...
		<ul class="skdslider">
			...
			<li> 
				<span class="temp">ТОП-5 НОВИН</span>
				<img src="https://farm9.staticflickr.com/8729/17154829932_d3937fd421_o.jpg" alt="">
			...
			<li> 
				<span class="temp">ТОП-5 НОВИН</span>
				<img src="http://www.mountainguides.com/photos/everest-south/c2_2011b.jpg" alt="">
				<div class="slide-desc">
					<h2>Slider Title 1</h2>
					<p>Demo description here. Demo description here. Demo description here. Demo description here. Demo description here. <a class="more" href="#">more</a></p>
				</div>
			...
			<li>
				<span class="temp">ТОП-5 НОВИН</span>
				<img src="https://farm8.staticflickr.com/7693/17156421925_e9e4120976_o.jpg" alt="">
			</li>
			<div class="slide-desc">
				<h2>Slider Title 1</h2>
				<p>Demo description here. Demo description here. Demo description here. Demo description here. Demo description here. <a class="more" href="#">more</a></p>
