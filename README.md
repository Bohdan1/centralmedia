...
ver. 0.99.34
  - Відключив автоматичне оновлення ядра (functions.php)
  - Сортування записів по даті в адмінці (functions.php)
  - Видалив файл header-second.php

ver. 0.99.33
  - встановив плагін AccessPress Social Login Lite (для авторизації через соц. мережі)
  - вивів іконки авторизації в модальному вікні авторизації (functions.php)

ver. 0.99.32
  - оптимізував pencil для нар. корисп.
  - встановив плагін WP Users Media (для відображення тільки своїх медіа в адмінці)

ver. 0.99.31
  - добавив пагінацію для сторінок
    - пошук (search.php, functions.php)
    - категорії (category.php)
    - автори (author.php)
  - приховав слово "SHARES" в плашці соц. мереж (style.css)
  - видалив файл archive.php

ver. 0.99.30
  - зробив іконки і текст на плашці соц. мереж білими
...
ver. 0.99.27
  ...
  - редагував документацію

ver. 0.99.26
  - переробив функціонал форми для Народного кореспондента(не до кінця)
  - сповіщення для публікацій Народного кореспондента, які чекають на підтвердження (functions.php)
...
ver. 0.99.23
  - добавив новий текст в футер
  - змінив фіксовану іконку народного кореспондента
  - забрав caps в made by ...
